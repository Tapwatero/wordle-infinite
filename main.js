  ...
  var ls = "IN_PROGRESS",
      ...
      ms = function(e) {
          ...
          function t() {
              ...
              return window.willFixStreak = !!e.lastCompletedTs && new Date(e.lastCompletedTs) < new Date(r), !e.lastPlayedTs || Ga(new Date(e.lastPlayedTs), e.today) >= 1 ? (e.boardState = new Array(6).fill(""), e.evaluations = new Array(6).fill(null), e.solution = Va(e.today), console.log(Fa(e.today), e.solution), e.dayOffset = Fa(e.today), e.lastCompletedTs = n.lastCompletedTs, e.hardMode = n.hardMode, e.restoringFromLocalStorage = !1, ja({
                  rowIndex: e.rowIndex,
              ...
              value: function() {
                  ...
                  if (["gamesPlayed", "winPercentage", "currentStreak", "maxStreak"].forEach((function(s) {
                      ...
                      m.appendChild(p), this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function(a) {
                          ...
                          }), (localStorage.removeItem("nyt-wordle-state"), location.reload()), (function() {
  ...
  var ct = 6e4,
      ...
      mt = function(e) {
          ...
          function t() {
              ...
              document.getElementById('content').size();
              var n = new Date;
